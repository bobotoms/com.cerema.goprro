Visits = {
	...
	insert: function(o,cb) {
        ...
        ***********************************/
        Visits.using('db').query("goprro","INSERT INTO visite_ouvrages (dateVisiteOuvrage, idUser, idFamille, nomOuvrage) SELECT '"+date+"', (select idUser from users where mail='"+mail+"'), idFamille, nomOuvrage FROM ouvrages WHERE idOuvrage='"+numOuvrage+"'",function(err,result){
