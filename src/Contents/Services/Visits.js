Visits = {
	...
	insert: function(o,cb) {
        ...
        ***********************************/
        Visit.using('db').query("goprro","INSERT INTO visite_ouvrages (dateVisiteOuvrage, idUser, nomOuvrage) VALUES ('"+date+"', '4', (select nomOuvrage from ouvrages where idOuvrage='"+numOuvrage+"'))",function(err,result){
				if (!err) {            
                    console.log("result");
                    console.log(result);
					cb(result);
